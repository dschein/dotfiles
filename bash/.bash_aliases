...
#altwin:swap_alt_win
alias keyboardlap=' xset -b ; xbindkeys -f ~/.config/xbindkeysrc ; setxkbmap -option altwin:swap_alt_win,shift:both_capslock,caps:ctrl_modifier,altwin:alt_super_win ; '
alias keyboardcode='xset -b ; xbindkeys -f ~/.config/xbindkeysrc ; setxkbmap -option altwin:swap_alt_win,shift:both_capslock ; '
